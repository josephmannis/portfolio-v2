        ...
        <div className="main-content-container">
            ...
            <div className="about-text-container">
                ...
                <p className="about-description">
                    Hi! I am a creative coder interested in projects that people
                    use to better themselves. I have experience in native mobile
                    development, web development, design, and group leadership.
                </p>

                <p className="about-description">
                    Aside from work, I love to explore outdoors, help lead two
                    on-campus mentorship programs as Branding Director of
                    <a
                        className="nav-link"
